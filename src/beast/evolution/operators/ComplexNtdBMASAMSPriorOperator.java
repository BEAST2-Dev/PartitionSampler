 ...
 * @author
 */
public class ComplexNtdBMASAMSPriorOperator extends Operator {
    ...
    public double split(int index1, int index2, int clusterIndex, int[] initClusterSites){
        try{
            ...
            QuietRealParameter newParam = getSample(paramBaseDistr, newModel, paramList.getUpper(), paramList.getLower());
            QuietRealParameter newFreqs = getSample(freqsBaseDistr, newModel, freqsList.getUpper(), freqsList.getLower());
            ...
            int newModelInt = (int)(double)newModel.getValue();
            logqSplit += paramBaseDistr.calcLogP(newParam, newModelInt) +
                    modelBaseDistr.calcLogP(newModel)+
                    freqsBaseDistr.calcLogP(newFreqs, newModelInt);
    ...
    public double merge(
        ...
        try{
            ...
            int removeModelInt = (int)(double)removedModel.getValue();
            logqMerge += paramBaseDistr.calcLogP(removedParam, removeModelInt)
                    + modelBaseDistr.calcLogP(removedModel)
                    + freqsBaseDistr.calcLogP(removedFreqs, removeModelInt);
