...
import beast.evolution.likelihood.ExtendedTempWVTreeLikelihood;
 ...
 */
public class NtdBMAGammaBMASAMSPriorOperator  extends Operator {
    ...
    public Input<ExtendedTempWVTreeLikelihood> tempLikelihoodInput = new Input<ExtendedTempWVTreeLikelihood>(
            "tempLikelihood",
    ...
    private ExtendedTempWVTreeLikelihood tempLikelihood;
    ...
    public double split(int index1, int index2, int clusterIndex, int[] initClusterSites){
        try{
            ...
            QuietRealParameter newAlpha = getSample(alphaBaseDistr, alphaList.getUpper(), alphaList.getLower());
            QuietRealParameter newInvPr = getSample(invPrBaseDistr, invPrList.getUpper(), invPrList.getLower());
            ...
            logqSplit += paramBaseDistr.calcLogP(newParam)
                    ...
                    + alphaBaseDistr.calcLogP(newAlpha)
                    + invPrBaseDistr.calcLogP(newInvPr)
    ...
    public double merge(
        ...
        try{
            ...
            logqMerge += paramBaseDistr.calcLogP(removedParam)
                    ...
                    + alphaBaseDistr.calcLogP(removedAlpha)
                    + invPrBaseDistr.calcLogP(removedInvPr)
    ...
    public void testCorrectness(
        ...
        double temp1 = Math.exp(tempLikelihood.calculateLogP(
                ...
                alphaList.getParameter(clusterIndex1),
                invPrList.getParameter(clusterIndex1),
                ratesList.getParameter(clusterIndex1),
                siteModelList.getParameter(clusterIndex1))
        );
        double temp2 = Math.exp(tempLikelihood.calculateLogP(
                ...
                alphaList.getParameter(clusterIndex2),
                invPrList.getParameter(clusterIndex2),
                ratesList.getParameter(clusterIndex2),
                siteModelList.getParameter(clusterIndex2))
        );
