...
import beast.math.distributions.ComplexDirichletProcess;
 ...
 *
 */
public class ComplexNtdBMADPPGibbsSampler extends Operator implements Loggable {
    ...
    public Input<ComplexDirichletProcess> dpInput = new Input<ComplexDirichletProcess>(
            "dirichletProcess",
    ...
    public Input<ConditionalParametricDistribution> paramBaseDistrInput = new Input<ConditionalParametricDistribution>(
            "paramBaseDistr",
            "The base distribution of the overall exchange rates in instantaneous rate matrix of a site given substitution model.",
            Input.Validate.REQUIRED
    );


    public Input<ConditionalParametricDistribution> freqsBaseDistrInput = new Input<ConditionalParametricDistribution>(
            "freqsBaseDistr",
            "The base distribution of the base freqencies given the substitution model.",
            Input.Validate.REQUIRED
    );



    public Input<ParametricDistribution> substModelBaseDistrInput = new Input<ParametricDistribution>(
            "substModelBaseDistr",
            "The base distribution of the substitution model",
            Input.Validate.REQUIRED
    );
    ...
    private ComplexDirichletProcess dp;
    private int sampleSize;
    private ConditionalParametricDistribution paramBaseDistr;
    private ParametricDistribution modelBaseDistr;
    private ConditionalParametricDistribution freqsBaseDistr;
    ...
    public void initAndValidate(){
        ...
        modelBaseDistr = substModelBaseDistrInput.get();
    ...
    public double proposal(){
        ...
        try{
            ...
            QuietRealParameter[] paramPreProposals = getSamples(paramBaseDistr,modelPreProposals,currParamVal.getUpper(),currParamVal.getLower());
            QuietRealParameter[] freqsPreProposals = getSamples(freqsBaseDistr,modelPreProposals,currFreqsVal.getUpper(),currFreqsVal.getLower());
    ...
    public QuietRealParameter[] getSamples(
            ...
            RealParameter[] conditions,
            double upper,
            double lower) throws Exception{

        QuietRealParameter[] samples = new QuietRealParameter[sampleSize];
        for(int i = 0; i < samples.length;i++){
            Double[] sampleVal = distr.sample(1, (int)(double)conditions[i].getValue())[0];
            samples[i] = new QuietRealParameter(sampleVal);
