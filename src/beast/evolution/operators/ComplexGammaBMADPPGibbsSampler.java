 ...
 */
public class ComplexGammaBMADPPGibbsSampler extends Operator implements Loggable {
    ...
    public double proposal(){
        ...
        try{
            ...
            QuietRealParameter[] ratesPreProposals = getSamples(ratesBaseDistr, siteModelPreProposals, ratesList.getUpper(), ratesList.getLower());
            QuietRealParameter[] alphaPreProposals = getSamples(alphaBaseDistr, siteModelPreProposals, alphaList.getUpper(), alphaList.getLower());
            QuietRealParameter[] invPrPreProposals = getSamples(invPrBaseDistr, siteModelPreProposals, invPrList.getUpper(), invPrList.getLower());
